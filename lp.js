(function() {
  ...
  function update() {
    ...
    var basePts = svg.selectAll("circle.base").data(dataset).attr("cx", function(d) {return d.x;}).attr("cy", function(d) {return d.y;})
    var tipPts = svg.selectAll("circle.tip").data(dataset).attr("cx", function(d) {return d.x + d.a;}).attr("cy", function(d) {return d.y + d.b;});
    var pointers = svg.selectAll("line.pointer").data(dataset).attr("x1", function(d) {return d.x;}).attr("y1", function(d) {return d.y;}).attr("x2", function (d) {return d.x + d.a;}).attr("y2", function (d) {return d.y + d.b;});
